...
public class Get_By_Invalid_Partner_UserID extends TestBase {
	int count = 0;
	JsonPath json;
	...
	public Get_By_Invalid_Partner_UserID() {
	...
	public void get_CBRCount() throws Exception {
		test = report.startTest("Get_By_Invalid_Partner_UserID");

		Response result = CBR_COUNT_GetCount.CBR_Count_Get("Invalid_Partner_UserId");
		...
		if (error_message.equals("partnerUserID does not Exist !!!")) {

			test.log(LogStatus.PASS, " Response message validation Passed for" + " " + "Invalid_Partner_UserId");
		} else {
